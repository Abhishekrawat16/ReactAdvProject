...
import { GET_ERRORS, GET_PROJECTS, GET_PROJECT, DELETE_PROJECT,GET_PROJECTTASKS} from './types';
...
export const getProjectTasks = () => async dispatch => {
    const res = await axios.get("http://localhost:8080/ProjectmanagementClient/api/projecttask/all");
    dispatch({
